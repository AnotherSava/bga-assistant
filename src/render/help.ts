...
<div class="help">
  ...
  <p>Turn-based BGA games can run for weeks. BGA Assistant reads the game log and reconstructs
  the full game state, so you can focus on strategy instead of recalling what happened moves ago.</p>
  ...
  <div class="help-section">
    ...
    <div class="help-sections-grid">
      ...
      <div class="help-grid-item"><span class="help-grid-label">Cards</span><span> All cards from each set, with an option to show <i>unknown</i> cards only; a card taken out of the game counts as located</span></div>
  ...
  <details class="help-section" name="help-innov">
    ...
    <div class="help-sections-grid">
      ...
      <div class="help-grid-item">Two cards can carry the same short candidate list instead of a name each. The pair is known, which of them is which is not, and the tracker leaves it that way rather than guessing.</div>
    </div>
  </details>
