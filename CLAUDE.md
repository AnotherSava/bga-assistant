...
- `src/time-tracking.ts` — game table play-time tracker (session types, URL parser, SessionTracker class — real-time mode + tournament/arena classification, BGA localStorage sync, CSV export/import, session/table deletion)
